"""Output ports of the documents context.
...
# It is re-exported here because it is also a port the documents context consumes.
from knowledge_assistant.shared.application.ports import EmbeddingProvider

__all__ = ["DocumentRepository", "EmbeddingProvider", "OpenRepository", "TextExtractor"]

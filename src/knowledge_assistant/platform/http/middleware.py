...
if the caller provided one (trace propagation), generated otherwise. The id is
...
exception is deliberately NOT re-raised: the traceback belongs in the logs
(logger.exception below), never in the client's response body.
"""
